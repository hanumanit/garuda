...
Q4_K_M, 26 GB — loading and generating on a 16 GB machine via `mmap`. Every quantised
type dots directly against an int8-quantised activation rather than expanding to `f32`
first. There is **no GPU backend**
...
- **Tests:** 188 (172 unit + 16 end-to-end HTTP)
